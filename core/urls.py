...
urlpatterns = [
    path('', providers_views.index_view, name='index'),
    
    path('admin/', admin.site.urls),
    
    # Login/Logout
    path('login/', providers_views.SistemaLoginView.as_view(), name='login'),
    ...
    path('exportar-mapeamento/', providers_views.exportar_mapeamento_csv, name='exportar_mapeamento'),
    
    # Gestão de Usuários (Centralizado)
    path('usuarios/', providers_views.gestao_usuarios, name='gestao_usuarios'),
    path('usuarios/editar/<int:user_id>/', providers_views.editar_usuario, name='editar_usuario'),
